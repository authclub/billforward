...
// WebhookPagedMetadata webhook paged metadata
// swagger:model WebhookPagedMetadata
...
func (m *WebhookPagedMetadata) validateCurrentOffset(formats strfmt.Registry) error {
...
func (m *WebhookPagedMetadata) validateExecutionTime(formats strfmt.Registry) error {
...
func (m *WebhookPagedMetadata) validateNextPage(formats strfmt.Registry) error {
...
func (m *WebhookPagedMetadata) validateRecordsRequested(formats strfmt.Registry) error {
...
func (m *WebhookPagedMetadata) validateResults(formats strfmt.Registry) error {
