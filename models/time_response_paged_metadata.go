...
// TimeResponsePagedMetadata time response paged metadata
// swagger:model TimeResponsePagedMetadata
...
func (m *TimeResponsePagedMetadata) validateCurrentOffset(formats strfmt.Registry) error {
...
func (m *TimeResponsePagedMetadata) validateCurrentPage(formats strfmt.Registry) error {
...
func (m *TimeResponsePagedMetadata) validateExecutionTime(formats strfmt.Registry) error {
...
func (m *TimeResponsePagedMetadata) validateNextPage(formats strfmt.Registry) error {
...
func (m *TimeResponsePagedMetadata) validateRecordsRequested(formats strfmt.Registry) error {
...
func (m *TimeResponsePagedMetadata) validateRecordsReturned(formats strfmt.Registry) error {
...
func (m *TimeResponsePagedMetadata) validateResults(formats strfmt.Registry) error {
