...
func (m *InvoicePagedMetadata) validateCurrentOffset(formats strfmt.Registry) error {
...
func (m *InvoicePagedMetadata) validateCurrentPage(formats strfmt.Registry) error {
...
func (m *InvoicePagedMetadata) validateExecutionTime(formats strfmt.Registry) error {
...
func (m *InvoicePagedMetadata) validateNextPage(formats strfmt.Registry) error {
...
func (m *InvoicePagedMetadata) validateRecordsRequested(formats strfmt.Registry) error {
...
func (m *InvoicePagedMetadata) validateRecordsReturned(formats strfmt.Registry) error {
...
func (m *InvoicePagedMetadata) validateResults(formats strfmt.Registry) error {
