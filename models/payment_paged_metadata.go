...
// PaymentPagedMetadata payment paged metadata
// swagger:model PaymentPagedMetadata
...
func (m *PaymentPagedMetadata) validateCurrentOffset(formats strfmt.Registry) error {
...
func (m *PaymentPagedMetadata) validateCurrentPage(formats strfmt.Registry) error {
...
func (m *PaymentPagedMetadata) validateExecutionTime(formats strfmt.Registry) error {
...
func (m *PaymentPagedMetadata) validateNextPage(formats strfmt.Registry) error {
...
func (m *PaymentPagedMetadata) validateRecordsRequested(formats strfmt.Registry) error {
...
func (m *PaymentPagedMetadata) validateRecordsReturned(formats strfmt.Registry) error {
...
func (m *PaymentPagedMetadata) validateResults(formats strfmt.Registry) error {
