...
// PaymentMethodPagedMetadata payment method paged metadata
// swagger:model PaymentMethodPagedMetadata
...
func (m *PaymentMethodPagedMetadata) validateCurrentPage(formats strfmt.Registry) error {
...
func (m *PaymentMethodPagedMetadata) validateRecordsReturned(formats strfmt.Registry) error {
